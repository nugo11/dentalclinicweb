...
const QuickActions = () => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button className="w-10 h-10 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center text-slate-400 hover:text-brand-purple transition-all">
        <Plus size={20} />
      </button>
    </div>
  );
