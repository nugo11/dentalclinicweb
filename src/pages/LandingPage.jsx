  ...
  <Link to={`/catalog/${id}`} className="block h-full group">
    <div className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col h-full relative overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-4 mb-8 relative z-10">
        <div className="w-20 h-20 rounded-[24px] bg-slate-50 border-2 border-white shadow-inner flex items-center justify-center shrink-0 overflow-hidden">
          {logoUrl ? (
      ...
      <div className="flex-1 relative z-10">
        <h4 className="text-2xl font-black text-brand-deep tracking-tight italic mb-2 group-hover:text-brand-purple transition-colors">
          {name}
        </h4>
      ...
      <div className="mt-8 pt-6 border-t border-slate-50 flex items-center gap-2 text-[10px] font-black text-brand-deep uppercase tracking-widest group-hover:gap-4 transition-all relative z-10">
...
const PricingTable = ({ onSelectPlan }) => {
  ...
  return (
    <>
      ...
      {/* Header */}
      <div style={{display:'grid',gridTemplateColumns:'1fr repeat(3,180px)',borderBottom:'1px solid #E2E8F0'}}>
      ...
      {/* Footer buttons */}
      <div style={{display:'grid',gridTemplateColumns:'1fr repeat(3,180px)',borderTop:'1px solid #E2E8F0',background:'#F8FAFC'}}>
